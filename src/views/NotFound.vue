  ...
  <div class="not-found flex flex-col items-center justify-center">
    <svg width="252" height="294">
      ...
      <g fill="none" fill-rule="evenodd">
        ...
        <path d="M119.306 107.329s.452 4.366-2.127 32.062" stroke="#E4EBF7" stroke-width="1.101" stroke-linecap="round"
          stroke-linejoin="round"></path>
        <path
    ...
    <div class="result-title pt-[48px] text-[36px]">404</div>
    <div class="result-subtitle text-[24px] text-[rgba(0,0,0,.45)] my-[24px]">{{ t('page.notFound') }}</div>
    <div class="w-[180px]">
      <van-button round block color="#FF356D"  type="primary" class="h-[80px]" @click="goHome">
